...
const VideoDetail = ({ postDetails }: PostProps) => {
  ...
  return (
    <div className="flex w-full bg-white flex-wrap lg:flex-nowrap lg:h-screen lg:overflow-hidden">
      ...
      <div className="lg:h-screen overflow-y-auto bg-red-500 w-full lg:flex-[1]">
